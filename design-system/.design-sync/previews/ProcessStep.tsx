...
/** Four stages, four registers, four ratios - never four equal frames.
    The palette carries the transformation: earth -> heat -> carbon -> atmosphere. */
...
export const SingleStep = () => (
  <ProcessStep stage="heat" index="02" name="pyrolysis" datum="540 °C" style={{ maxWidth: 300 }}>
    <Figure register="plant" src={PLANT} alt="Kiln exterior at blue hour" ratio={1.4} />
  </ProcessStep>
);
