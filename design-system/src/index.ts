/**
 * terra carbon design system
 * biochar - climate solutions
 */

export { TerraCarbonProvider } from './components/TerraCarbonProvider';
export type { TerraCarbonProviderProps } from './components/TerraCarbonProvider';
